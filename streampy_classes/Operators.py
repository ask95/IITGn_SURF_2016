...
##     """
##     print '*******************************'
##     print 'remove_novalue_and_open_multivalue'
##     print 'l', l
...
def op_agent(f_type, f, in_stream, out_stream,
    ...
    def g(x, state=None):
        try:
            ...
            print 'Exception in Operations.py, in op_agent, in g()'
            print 'state = ', state
            print 'input x = ', x
            print 'input stream name = ', in_stream.name
            print 'output stream name = ', out_stream.name
            print 'f_type = ', f_type
            print 'x[0] = ', x[0]
            print 'call_streams = ', call_streams
...
def stream_func(inputs, f_type, f, num_outputs, state=None, call_streams=None,
    ...
    if not((inputs is None) or
        ...
        raise TypeError('In Operators.py. Expected inputs to be None, Stream or list of Streams, not:',
                        inputs)
